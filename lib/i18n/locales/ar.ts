...
export const ar: LandingTranslations = {
  ...
  pricing: {
    badge: "الأسعار",
    title1: "ابدأ مجاناً.",
    title2: "ارفع إلى Pro عند الحاجة.",
    description:
      "مجاني للأبد للإملاء اليومي. Pro يزيل القيود حين يقوم صوتك بعمل جاد.",
    monthly: "شهري",
    annual: "سنوي",
    saveBadge: "وفر 20%",
    free: {
    ...
    pro: {
      ...
      features: [
        "إملاء غير محدود",
        "Mac و Windows على كل جهاز تسجل دخوله",
        "99 لغة",
        "بدون احتفاظ — صوتك يبقى خاصاً",
        "دعم بأولوية",
      ],
    ...
    comparison: {
      eyebrow: "كيف يقارَن Bisbi",
      title: "نفس القوة. سعر أفضل.",
      columns: {
        bisbi: "Bisbi Pro",
        wispr: "Wispr Flow",

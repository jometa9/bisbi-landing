...
export const hi: LandingTranslations = {
  ...
  features: {
    ...
    items: [
      ...
      {
        title: "नेटिव और हल्का ऐप",
        description:
          "आपकी मशीन पर घर जैसा महसूस हो — इसके लिए बना। तेज़, हल्का, और बिना रुकावट।",
      },
    ],
  },
  speedComparison: {
    ...
    keyboardHint: "औसत टाइपिस्ट की गति।",
    bisbiLabel: "Bisbi",
    bisbiHint: "बोलने की प्राकृतिक गति।",
    phrases: [

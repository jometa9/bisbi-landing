  ...
  return (
    <div className="pricing-wrap">
      <div className="pricing-head">
        <span className="pricing-badge">{p.badge}</span>
      ...
      <div className="pricing-toggle-wrap">
        <div className="pricing-toggle" role="tablist" aria-label={p.badge}>
          <button
            type="button"
            role="tab"
      ...
      <div className="pricing-compare">
        <div className="pricing-compare-head">
          <span className="pricing-compare-eyebrow">{p.comparison.eyebrow}</span>
          <h3 className="pricing-compare-title">{p.comparison.title}</h3>
        </div>
          ...
          <table className="pricing-compare-table">
            <thead>
              <tr>
                ...
                <th className="is-bisbi">{p.comparison.columns.bisbi}</th>
                <th>{p.comparison.columns.wispr}</th>
                <th>{p.comparison.columns.vibetyper}</th>
              </tr>
            </thead>
            <tbody>
        ...
        <p className="pricing-compare-note">{p.comparison.note}</p>
      </div>
    </div>
  );
}
